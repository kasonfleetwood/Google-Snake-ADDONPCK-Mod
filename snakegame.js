window.snake.scheme = function(settings = {}) {
  if(settings.scoreBar === undefined)
    settings.scoreBar = '##eeff00';
  if(settings.borders === undefined)
    settings.borders = '#a2ff00';
  ...
  if(settings.separators === undefined)
    settings.separators = '#ffffff';
  if(settings.buttons === undefined)
    settings.buttons = '#00e5ff';
  ...
  wall_img.src = 'https://github.com/Ljubov123414/Google-Snake-ADDONPCK-Mod/blob/main/trophy-01%20(1).png?raw=true';
